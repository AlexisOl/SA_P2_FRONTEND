...
import { RegisterDTO, Rol, UserDTO } from '@/models/user.model';
  ...
  template: `
    <div class="w-full max-w-6xl mx-auto p-6">
      ...
      <form
        [formGroup]="form"
        (ngSubmit)="onSubmit()"
        class="grid grid-cols-12 gap-4 card p-4 mb-6"
      >
        <div class="col-span-12 md:col-span-6">
          ...
          />
          <small class="text-red-500" *ngIf="invalid('nombre')"
        ...
        <div class="col-span-12 md:col-span-6">
          ...
          />
          <small class="text-red-500" *ngIf="invalid('email')"
            >Correo inválido.</small
          >
        </div>
        ...
        <div class="col-span-12 md:col-span-6">
          ...
          <small class="text-gray-500 block"
            >Mín 8, con mayúscula, minúscula, número y símbolo.</small
          >
          <small class="text-red-500" *ngIf="invalid('password')"
            >Contraseña no cumple requisitos.</small
          >
        </div>
        ...
        <div class="col-span-12 md:col-span-3">
          ...
          />
          <small class="text-red-500" *ngIf="invalid('dpi')"
            >Debe contener 13 dígitos.</small
          >
        </div>
        ...
        <div class="col-span-12 md:col-span-3">
          ...
          <p-select
            ...
            optionLabel="label"
            optionValue="value"
            [ngClass]="{ 'p-invalid': invalid('rol') }"
          ></p-select>
          <small class="text-red-500" *ngIf="invalid('rol')"
            >Selecciona un rol.</small
          >
        </div>
      ...
      <div class="flex items-center justify-between mb-3">
        ...
        <div class="flex gap-2 items-end">
          ...
          <input
            ...
            class="w-16rem"
            [(ngModel)]="filtros.q"
            placeholder="Buscar nombre/email/dpi"
          />
          <p-button
            label="Buscar"
            icon="pi pi-search"
        ...
        >
          ...
          <ng-template #body let-u>
            <tr>
              ...
              <td>
                <p-tag
                  [value]="u.enabled ? 'ACTIVO' : 'INACTIVO'"
...
export class RegisterComponent implements OnInit {
  ...
  constructor(private alertS: AlertaServiceService) {}
  ...
  onSubmit() {
    ...
    this.auth
      ...
      .subscribe({
        next: (u) => {
          this.alertS.generacionAlerta(
            'Usuario registrado',
            u?.email ?? '',
            'success',
          );

          // this.toast.add({ key: 'global', severity: 'success', summary: 'Registro exitoso', detail: u?.email ?? 'Creado' });
        ...
        error: (err) => {
          const detail =
            err?.error?.message || err.message || 'No se pudo registrar';
          this.alertS.generacionAlerta('Error', detail, 'error');

          // this.toast.add({ key: 'global', severity: 'error', summary: 'Error', detail });
        },
      });
  }
    ...
    this.usersSvc.listar(params).subscribe({
      ...
      error: (err) =>
        this.toast.add({
          severity: 'error',
          summary: 'Error',
          detail: err?.error?.message || 'No se pudieron cargar usuarios',
        }),
    });
  }
